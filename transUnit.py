...
class TestingTransform (unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        load_all_transformers()
    ...
    def test_indentity(self):
        t = TransformIndentity(self.genKey)
    ...
    def test_sub(self):
        ...
        tdata = t.transform(self.data)
        adata = b'\xb0\xb1\xb2\xb3\xb4\xb5\xb6\xb7\xb8\xb9\xba'
        self.assertEqual(adata, tdata)
